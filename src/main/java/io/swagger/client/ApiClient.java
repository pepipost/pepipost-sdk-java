...
public class ApiClient {
    ...
    private String basePath = "https://api.pepipost.com/";
    ...
    public ApiClient() {
        ...
        setUserAgent("pepipost-sdk-java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.pepipost.com/
    ...
    public <T> T handleResponse(Response response, Type returnType) throws ApiException {
        if (response.isSuccessful()) {
            ...
            if (response.code() == 204) {
                ...
                throw new ApiException("Nothing has been returned in response.");
                //return null;
            } else {
                ...
                Hashtable<String, String> decodedResponse = new Hashtable<String, String>();
                decodedResponse = json.deserialize(respBody, Hashtable.class);
                int errorcode =  Integer.parseInt(decodedResponse.get("errorcode"));
                //checking if any defined api error occurred
                if(errorcode > 0 ){
                    throw new ApiException(errorcode,decodedResponse.get("errormessage"));
                }
