...
public class SetrecurringcreditddetailsController extends BaseController {
     ...
     * @return The singleton instance of the SetrecurringcreditddetailsController class 
     */
    public static SetrecurringcreditddetailsController getInstance() {
        if (null == instance) {
    ...
    public Object createSetrecurringcreditddetailsPOST(
        ...
        return _handleCreateSetrecurringcreditddetailsPOSTResponse(_context);
    }
    ...
    public void createSetrecurringcreditddetailsPOSTAsync(
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                try {
                    _request = _buildCreateSetrecurringcreditddetailsPOSTRequest(body);
                } catch (Exception e) {
                ...
                getClientInstance().executeAsStringAsync(_request, new APICallBack<HttpResponse>() {
                    public void onSuccess(HttpContext _context, HttpResponse _response) {
                        try {
                            Object returnValue = _handleCreateSetrecurringcreditddetailsPOSTResponse(_context);
    ...
    private HttpRequest _buildCreateSetrecurringcreditddetailsPOSTRequest(
        ...
        StringBuilder _queryBuilder = new StringBuilder(_baseUri + "/setrecurringcreditddetails");
    ...
    /**
     * Processes the response for createSetrecurringcreditddetailsPOST
     * @return An object of type Object
     */
    private Object _handleCreateSetrecurringcreditddetailsPOSTResponse(HttpContext _context)
