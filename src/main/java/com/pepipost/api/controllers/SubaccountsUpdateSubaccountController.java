...
public class SubaccountsUpdateSubaccountController extends BaseController {
    //private static variables for the singleton pattern
    private static final Object syncObject = new Object();
    private static SubaccountsUpdateSubaccountController instance = null;

    /**
     * Singleton pattern implementation 
     * @return The singleton instance of the SubaccountsUpdateSubaccountController class 
     */
    public static SubaccountsUpdateSubaccountController getInstance() {
        if (null == instance) {
            synchronized (syncObject) {
                if (null == instance) {
                    instance = new SubaccountsUpdateSubaccountController();
                }
            }
        }
        return instance;
    ...
    public Object createSubaccountsUpdateSubaccountPOST(
        ...
        return _handleCreateSubaccountsUpdateSubaccountPOSTResponse(_context);
    }
    ...
    public void createSubaccountsUpdateSubaccountPOSTAsync(
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                try {
                    _request = _buildCreateSubaccountsUpdateSubaccountPOSTRequest(body);
                } catch (Exception e) {
                ...
                getClientInstance().executeAsStringAsync(_request, new APICallBack<HttpResponse>() {
                    public void onSuccess(HttpContext _context, HttpResponse _response) {
                        try {
                            Object returnValue = _handleCreateSubaccountsUpdateSubaccountPOSTResponse(_context);
    ...
    private HttpRequest _buildCreateSubaccountsUpdateSubaccountPOSTRequest(
        ...
        StringBuilder _queryBuilder = new StringBuilder(_baseUri + "/subaccounts/updateSubaccount");
    ...
    /**
     * Processes the response for createSubaccountsUpdateSubaccountPOST
     * @return An object of type Object
     */
    private Object _handleCreateSubaccountsUpdateSubaccountPOSTResponse(HttpContext _context)
